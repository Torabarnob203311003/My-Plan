...
export default function Reviews() {
  return (
    <section className="max-w-5xl mx-auto w-full px-10 mb-10 dark:bg-gray-800 dark:text-white">
      {/* Header */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-5 w-full">
        ...
        <div
          ...
          <div className="flex flex-col">
            <img src="https://randomuser.me/api/portraits/women/54.jpg" alt="Jane Cooper" className="h-10 w-10 rounded-full mb-2 object-cover" />
        ...
        <div
          ...
          <div className="flex flex-col">
            <img src="https://randomuser.me/api/portraits/women/30.jpg" alt="Emily Smith" className="h-10 w-10 rounded-full mb-2 object-cover" />
        ...
        <div
          ...
          <div className="flex flex-col">
            <img src="https://randomuser.me/api/portraits/women/90.jpg" alt="Sarah Brown" className="h-10 w-10 rounded-full mb-2 object-cover" />
        ...
        <div
          ...
          <div className="flex flex-col">
            <img src="https://randomuser.me/api/portraits/men/90.jpg" alt="James White" className="h-10 w-10 rounded-full mb-2 object-cover" />
