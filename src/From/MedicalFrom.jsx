...
const Step2 = ({ nextStep, prevStep }) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <input type="text" placeholder="Health Insurance" {...register("healthInsurance", { required: "Health Insurance is required" })} className="w-full px-4 py-3 border rounded-lg" />
      {errors.healthInsurance && <p className="text-red-500">{errors.healthInsurance.message}</p>}

      <input type="text" placeholder="Supplemental Insurance" {...register("supplementalInsurance")} className="w-full px-4 py-3 border rounded-lg" />

      <input type="text" placeholder="Medications" {...register("medications")} className="w-full px-4 py-3 border rounded-lg" />

      <input type="text" placeholder="Ailments" {...register("ailments")} className="w-full px-4 py-3 border rounded-lg" />
